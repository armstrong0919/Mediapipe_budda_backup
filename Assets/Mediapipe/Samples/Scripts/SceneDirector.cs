...
public class SceneDirector : MonoBehaviour
{
  ...
  static void GetCurrentContext(int eventId) {
    ...
    internal void ChangeWebCamDevice(int device)
    {
    ...
    void StartGraph()
    {
        if (graphRunner != null)
        {
          //  var SceneDirector_graph = GameObject.Find("SceneDirector_graph").GetComponent<Text>();
          //  SceneDirector_graph.text = "SceneDirector_graph's StartGraph is running!";
    ...
    IEnumerator RunGraph()
    {
        ...
        if (graphPrefab == null)
        {
          //  var scenedirector_rungraphgraphPrefab = GameObject.Find("SceneDirector_graph_run＿graphgraphPrefab").GetComponent<Text>();
          //  scenedirector_rungraphgraphPrefab.text = "SceneDirector_graph_rungraph＿graphPrefab's StartGraph is running!";
        ...
        if (IsGpuEnabled())
        {
          //  var scenedirector_run_gupenable = GameObject.Find("SceneDirector_graph_run＿_gupenable").GetComponent<Text>();
          //  scenedirector_run_gupenable.text = "SceneDirector_graph_rungraph＿_gupenable's StartGraph is running!";
        ...
        while (true)
        {
          ...
          //  var scenedirector_run_true= GameObject.Find("SceneDirector_graph_run＿true").GetComponent<Text>();
          //  scenedirector_run_true.text = "SceneDirector_graph_rungraph＿true's StartGraph is running!";
        }
    }
