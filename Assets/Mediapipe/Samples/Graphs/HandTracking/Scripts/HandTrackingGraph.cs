...
public class HandTrackingGraph : DemoGraph{
  ...
  private FingerGroup fingerGroup;
  private GameManager_Hand gameManager_Hand;
  ...
  private void turnOnComponent()
  {
    if (fingerGroup ==  null) {
        fingerGroup = GetComponent<FingerGroup>();
        fingerGroup.getFingers();

        gameManager_Hand = GetComponent<GameManager_Hand>();
        gameManager_Hand.enabled = true;
        }
  }
